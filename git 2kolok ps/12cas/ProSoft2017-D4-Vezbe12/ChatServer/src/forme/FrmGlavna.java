...
import modelitabele.KorisnikView;
...
public class FrmGlavna extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Pokretanje Servera"));
    ...
    private void btnPokreniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPokreniActionPerformed
        ...
        if (port>=8000){
            TableModelLogovaniKorisnici tmlk = (TableModelLogovaniKorisnici) tblKorisnici.getModel();
            Start start  = new Start(port,tmlk);
            start.start();
            ...
            JOptionPane.showMessageDialog(null, "NISTE DOBRO UNELI PORT!!!");
    ...
    private void srediTabelu() {
        TableModelLogovaniKorisnici tmlk = new TableModelLogovaniKorisnici(new ArrayList<KorisnikView>());
        tblKorisnici.setModel(tmlk);
