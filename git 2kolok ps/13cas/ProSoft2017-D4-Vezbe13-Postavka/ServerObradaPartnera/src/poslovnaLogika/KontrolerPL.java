...
import so.poslovnipartner.VratiPoslovnePartnereSO;
...
public class KontrolerPL {
    ...
    public List<Mesto> vratiSvaMesta() throws Exception {
     ...
     public List<PoslovniPartner> vratiSvePartnere() throws Exception {
         VratiPoslovnePartnereSO so = new VratiPoslovnePartnereSO();
         so.opsteIzvrsenjeSO(new PoslovniPartner());
         return so.getPartneri();
    }
     
    public List<Proizvod> vratiSveProizvode() throws Exception {
        VratiProizvodeSO so = new VratiProizvodeSO();
        so.opsteIzvrsenjeSO(new Proizvod());
