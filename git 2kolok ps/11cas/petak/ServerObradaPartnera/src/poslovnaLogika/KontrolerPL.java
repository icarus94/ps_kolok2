...
import so.SacuvajPartneraSO;
import so.VratiSvePartnereSO;
import so.VratiSveProizvodeSO;
...
public class KontrolerPL {
    ...
    public List<Mesto> vratiSvaMesta() throws Exception {
     ...
     public List<PoslovniPartner> vratiSvePartnere() throws Exception {
        ...
        //return dbbr.vratiSvePartnere();
         ...
         VratiSvePartnereSO vratiSvePartnereSO = new VratiSvePartnereSO(dbbr);
         vratiSvePartnereSO.opsteIzvrsenjeSO();
         return vratiSvePartnereSO.getListaPartnera();
    }
    ...
    public List<Proizvod> vratiSveProizvode() throws Exception {
       ...
       VratiSveProizvodeSO vratiProizvodeSO = new VratiSveProizvodeSO(dbbr);
       vratiProizvodeSO.opsteIzvrsenjeSO();
       return vratiProizvodeSO.getListaProizvoda();
    } 
    ...
    public void sacuvajPartnera(PoslovniPartner partner) throws Exception {
       ...
       // }
        ...
        SacuvajPartneraSO sacuvajPartneraSO = new SacuvajPartneraSO(dbbr);
        sacuvajPartneraSO.setPartner(partner);
        sacuvajPartneraSO.opsteIzvrsenjeSO();
    }
